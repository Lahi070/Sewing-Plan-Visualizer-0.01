...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100/60 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-slate-200/80 pb-4">
          ...
          {dataset.metadata.lastUpdated && (
            <div className="text-[11px] text-slate-500 font-mono bg-white px-3 py-1.5 rounded-xl border border-slate-200 shadow-2xs self-start sm:self-auto">
      ...
      {/* Floor Footer */}
      <footer className="border-t border-slate-200 bg-white py-4 text-center text-xs text-slate-500 no-print mt-8">
